...
public class HvcJarTests extends LanguageTests {
  public static Java javaInternalHvcApiV1, javaInternalHvcApiV2;
  ...
  static void beforeAll() {
    javaInternalHvcApiV1 = new Java(GenerationMode.INTERNAL, ApiVersion.V1, JarType.HVC);
    javaInternalHvcApiV2 = new Java(GenerationMode.INTERNAL, ApiVersion.V2, JarType.HVC);
  }
  ...
  void baseDirectoryShouldNotBeClearedBeforeGenerationForApiV1IntJar() {
    assertThat(javaInternalHvcApiV1.cleanDirectoryBeforeGenerate()).isFalse();
  }
  ...
  void shouldCreateModelsDirectoryForApiV1Models() throws IOException {
    ...
    List<FileOp> fileOps = javaInternalHvcApiV1.generate(basePath, spec);
...
public enum PaymentMethod {
  ...
  void baseDirectoryShouldNotBeClearedBeforeGenerationForApiV2IntJar() {
    assertThat(javaInternalHvcApiV2.cleanDirectoryBeforeGenerate()).isFalse();
  }
  ...
  void shouldCreateModelsDirectoryForApiV2Models() throws IOException {
    ...
    List<FileOp> fileOps = javaInternalHvcApiV2.generate(basePathForApiV2, spec);
...
""");
  ...
  @Test
  void shouldHaveLongDataTypeForMoneyColumnAndHvcJar() throws IOException {
    var addon =
        buildResource("addon")
            .withAttribute(
                "price",
  ...
  @Test
  void shouldHaveLongDataTypeForLongMoneyColumnAndHvcJar() throws IOException {
    var addon =
