...
import com.chargebee.sdk.java.models.EnumColumn;
import com.chargebee.sdk.java.models.VisibleEnumEntries;
...
public class SchemaLessEnumParser {
  ...
  private static List<VisibleEnumEntries> getEnumEntries(Attribute attribute) {
